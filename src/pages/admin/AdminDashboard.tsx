    ...
    if (!isAuthenticated) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] flex items-center justify-center p-4 relative overflow-hidden">
                ...
                <div className="modern-modal bg-white/95 backdrop-blur-xl p-8 max-w-md w-full text-center relative z-10 shadow-2xl">
                    ...
                    <form onSubmit={handlePinSubmit} className="space-y-4">
                        <div>
                            <input
                                ...
                                className="w-full text-center text-2xl tracking-widest font-bold py-3 border-2 border-gray-200 rounded-xl focus:border-[#1044A9] focus:ring-0 outline-none transition-colors bg-white/50 backdrop-blur-sm"
                                placeholder="•••••"
                                autoFocus
                                maxLength={5}
                            />
                        ...
                        <button
                            type="submit"
                            className="action-btn-modern action-btn-primary w-full group relative flex items-center justify-center gap-2 py-4 text-white font-bold text-lg rounded-xl transition-all duration-300 border-none"
                        >
                            <span className="relative z-10">Déverrouiller</span>
                            <Unlock size={20} className="relative z-10 opacity-70 group-hover:opacity-100 transition-opacity" />
                        </button>
                    </form>
        ...
        <div className="admin-layout flex h-screen bg-gray-50 text-gray-800 font-sans overflow-hidden">
            ...
            `}>
                <div className="h-16 flex items-center justify-between px-6 border-b border-white/10">
                    <span className="sidebar-logo text-xl font-bold text-white">EP2C Admin</span>
                ...
                <div className="flex-1 overflow-auto p-8">
                    {selectedUser ? (
                        ...
                        <>
                            <div className="mb-8">
                                <div className="flex flex-col md:flex-row md:items-start justify-between mb-6 gap-4">
                                    ...
                                    <button
                                        ...
                                        className="action-btn-modern action-btn-primary flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-200 text-sm font-semibold border-none"
                                    >
                                        <UserPlus size={18} />
                                        Nouveau Client
                                    </button>
                            ...
                            {/* CREATE MODAL */}
                            {showCreateForm && (
                                <div className="modern-modal-backdrop fixed inset-0 z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
                                    <div className="modern-modal bg-white max-w-md w-full overflow-hidden">
                            ...
                            <div className="modern-table bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
