...
export default function FloatingWhatsApp() {
    ...
    useEffect(() => {
        const handleScroll = () => {
            // Find the footer element - assuming it has a 'footer' tag or specific class if added
            ...
            // Hide if footer is starting to be visible
            // We use a small offset (e.g., 50px) to make it disappear just before overlapping
    ...
    return (
        <a
            ...
            className={`fixed z-[60] bottom-8 right-8 transition-all duration-500 cubic-bezier(0.4, 0, 0.2, 1) transform hover:scale-110 
