                ...
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    <div className="relative mt-10 lg:mt-0">
                        <Reveal delay="delay-200">
                            ...
                            <div className="relative z-10 flex flex-col md:flex-row items-center justify-end">
                                
                                {/* Image side */}
                                <div className="relative w-full md:w-[85%] rounded-tl-[4rem] rounded-br-[4rem] overflow-hidden shadow-2xl aspect-[4/5] z-10 bg-gray-900">
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center group cursor-pointer">
                                        <div className="w-16 h-16 bg-[#1044A9] rounded-full flex items-center justify-center text-white shadow-2xl group-hover:scale-110 transition-transform relative z-10">
                                    ...
                                    <div className="absolute bottom-0 right-0 w-full h-1/2 bg-gradient-to-tr from-[#2962ff]/80 to-transparent opacity-80"></div>
                                </div>

                                {/* The active tab text box */}
                                <div className="bg-white p-8 md:p-10 shadow-2xl rounded-2xl z-20 w-full md:w-[380px] border border-gray-100 absolute left-0 md:-left-8 top-1/2 -translate-y-1/2">
                                    <p className="text-gray-600 leading-relaxed text-lg font-medium relative z-10">
                                        {tabs.find(t => t.id === activeTab)?.content}
                                    </p>
                                    <div className="absolute -right-3 top-1/2 -translate-y-1/2 w-6 h-6 bg-white rotate-45 border-t border-r border-gray-100 hidden md:block"></div>
                                </div>
                            </div>
                        </Reveal>
                    </div>
